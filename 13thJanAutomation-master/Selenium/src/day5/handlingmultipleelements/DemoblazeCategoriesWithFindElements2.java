...
public class DemoblazeCategoriesWithFindElements2 {
	...
	public static void main(String[] args) {
		...
		l1.add("Laptops");
		l1.add("Monitors");
		// Logic to get one by one element from the list and performing validation on
		// that
...
/**
 * 
 * findElements(By) ---> List<WebElement> ---> use to identify multiple elements
 * or when you want to perform operation on multiple elements ---> we use
 * findElements(By) ---> in order count the identified element you size() --->
 * in order get specific element from the list use get(int index) ---> return
 * WebElement
 * 
 */ 