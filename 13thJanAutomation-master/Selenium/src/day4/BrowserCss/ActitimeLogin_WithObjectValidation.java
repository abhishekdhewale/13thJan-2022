...
//		driver.manage().window().maximize();
		...
		System.out.println(
				"Default text validation for username field: " + actualDefaultTextOnUsernameField.equals("Username"));
		...
		System.out.println(
				"Default text validation for password field: " + actualDefaultTextOnPasswordField.equals("Password"));
		// perform appropriate action the identified element
...
/**
 * visible -----> isDisplayed()--true/false ---> input, button, link, radio
 * button, checkbox, dropdown, image .... functional -----> isEnabled()
 * --true/false ---> input, button, link, radio button, checkbox, dropdown,
 * image .... selected -----> isSelected() --true/false ---> radio button,
 * checkbox validate text-----> getText() --String ---> use to get inner text of
 * any Web Element
 * 
 * <htmatag> innertext </htmltag> <a href="https://www.google.com">Forgot
 * Password</a> <div > Sample text </div> <span > Demo Text </span>
 * <td >Testing bug</td>
 * 
 * attribute validation: getAttribute(String attributename) --> String--> it
 * will return attribute value based on the given name
 * 
 * <input type="text" name="username" value="" id="username" class="textField"
 * placeholder="Username">
 * 
 * WebElement userNameInputField=driver.findElement(By.id("username"));
 * 
 * String acutalPlaceholderName=userNameInputField.getAttribute("placeholder");
 * String acutalClassName=userNameInputField.getAttribute("class"); String
 * acutalName=userNameInputField.getAttribute("name"); String
 * acutalTypeValue=userNameInputField.getAttribute("type");
 * 
 */