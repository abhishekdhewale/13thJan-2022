...
class parent
{
	static void s1()
	{
		System.out.println("From parent:" + "static s1()");
	}
	void s2()
	{
		System.out.println("from parent:" + "non-static(instance) s2()");
	}
}
class child extends parent
{
	static void s1()
	{
		System.out.println("from child static s1()");
	}
	
	
	public void s2()
	{
		System.out.println("from child" + "non-static (instance) s2()");
	}
}
