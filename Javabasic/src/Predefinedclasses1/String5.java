...
public class String5 
{
	...
	public static void main(String[] args)
	{
		...
		System.out.println("After Concatenated value of s2 is:" + s2);
		System.out.println("After Concatenated value of s3 is:" + s3);
		
		String a1="Manual";
		String a2="Auto";
		
		String x1=s2.concat(s3);
		String x2=a1.concat(a2);
		String x3=a1+a2;
		String x4=x1.concat(x2);
		System.out.println(x1);
		System.out.println(x2);
		System.out.println(x3);
		System.out.println("Concatenated String:" + x4);
		...
		System.out.println("Size of s4:" + s4.length());
		...
		System.out.println("last Index of e = " + s4.lastIndexOf('e',11));
