...
public class String0  
{
	...
	{
		String0 a = new String0();
		System.out.println("A:" + a);//String representation of an object because of toString()
		...
		System.out.println("s1 & s3 using equals():" + s1.equals(s3));//false//compare s1 and s3 values
		System.out.println("s1 & s3 using '==': " + (s1==s3));//false//compare s1 and s3 address
		
		String s4 = new String("Mumbai");//two objects--> 1. in constant pool 2. in non-constant pool
		System.out.println("s4:" + s4);//
		
		System.out.println("s1 & s4 using equals():" + s1.equals(s4));//true//compare s1 and s3 values
		System.out.println("s1 & s4 using '==': " + (s1==s4));//false//compare s1 and s3 address
		
		String s5 = new String("Mumbai");//two objects--> 1. in constant pool 2. in non-constant pool
		System.out.println("s5:" + s5);
		
		System.out.println("s4 & s5 using equals():" + s4.equals(s5));//true//compare s1 and s3 values
		System.out.println("s4 & s5 using '==': " + (s4==s5));//false//compare s1 and s3 address
		
		String s6 = new String("Hyderabad");//two objects--> 1. in constant pool 2. in non-constant pool
		System.out.println("s6:" + s6);
		System.out.println("s1 & s6 using equals():" + s1.equals(s6));//false//compare s1 and s3 values
		System.out.println("s1 & s6 using '==':" + (s1==s6));//false//compare s1 and s3 address
